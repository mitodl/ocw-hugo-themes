...
| ------------------------- | ----------------------------- | --------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `GTM_ACCOUNT_ID`          | `base-theme`, `www`, `course` | `GTM-XXXX&gtm_auth=...&gtm_preview=env-1&gtm_cookies_win=x` | A Google Tag Manager container ID, optionally with appended GTM environment params |
...
| `POSTHOG_COURSE_V3_ENABLED` | `course-v3` | `true` | Whether PostHog analytics are enabled for the `course-v3` theme
| `POSTHOG_COURSE_V3_PROJECT_API_KEY` | `course-v3` | `api-key` | API key for the PostHog project used by the `course-v3` theme |
