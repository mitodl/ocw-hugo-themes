...
test.describe("Course v3 Video View Page", () => {
  ...
  test("Video view page renders with correct structure", async ({ page, siteAlias }) => {
  ...
  test("Video view header displays category and title", async ({ page, siteAlias }) => {
  ...
  test("Video view category styles are correct", async ({ page, siteAlias }) => {
  ...
  test("Video view title styles are correct", async ({ page, siteAlias }) => {
  ...
  test("Video view header has correct gap", async ({ page, siteAlias }) => {
    const header = page.locator(".video-view-header")
    await expect(header).toHaveCSS("gap", "16px")
  })

  test("Video view meta block has correct styling", async ({ page, siteAlias }) => {
  ...
  test("Video view content section exists", async ({ page, siteAlias }) => {
    const content = page.locator(".video-view-content")
    await expect(content).toBeVisible()
  })

  test("Video player is rendered", async ({ page, siteAlias }) => {
  ...
  test("Video page layout has correct gap", async ({ page, siteAlias }) => {
    const videoPage = page.locator(".video-view-page-v3")
    await expect(videoPage).toHaveCSS("gap", "40px")
  })

  test("Video page has correct background color", async ({ page, siteAlias }) => {
    const videoPage = page.locator(".video-view-page-v3")
