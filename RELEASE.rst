...
- feat: enable posthog event capture by default (#1830)
- feat: line-based truncation for the course-v3 course description (#1826)
...
- fix(deps): update dependency video.js to v8 (#1502)
